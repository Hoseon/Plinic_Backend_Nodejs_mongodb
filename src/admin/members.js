...
router.get("/Main", function (req, res) {
  return res.render("PlinicAdmin/Members/Main/index", {});
});
//고객 관리 메인 화면

router.get("/MemberMgt", function (req, res) {
  return res.render("PlinicAdmin/Members/MemberMgt/index", {});
});
//고객 관리 회원 리스트 화면

router.get("/MemberMgt/show", function (req, res) {
  return res.render("PlinicAdmin/Members/MemberMgt/show", {});
});
//고객 관리 show 화면
