...
exports.skinAnalySave = (req, res) => {
  ...
  // console.log("-------------------------------request-------------");
  // console.log("-------------------------------response-------------" + res.body.id);
  // console.log(req.body.input.filename);
  // console.log(req.body.output.skin_analy.tone);
  // console.log(req.body.output.skin_analy.pore);
  // console.log(req.body.output.skin_analy.wrinkles);
  // console.log(req.body.output.created_at);
