...
var challengelogSchema = mongoose.Schema({
...
challengelogSchema.methods.getFormattedDate = function (date) {
  return date.getFullYear() + "-" + get2digits(date.getMonth()+1)+ "-" + get2digits(date.getDate());
};

challengelogSchema.methods.getFormattedTime = function (date) {
...
var ChallengeLog = mongoose.model('challengelog',challengelogSchema);
